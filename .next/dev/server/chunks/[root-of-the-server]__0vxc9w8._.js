...
async function GET(req) {
    ...
    if (!cardId) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    const res = await db.execute({
        sql: 'SELECT * FROM comments WHERE card_id = ? ORDER BY created_at ASC',
        args: [
            parseInt(cardId)
        ]
    });
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(res.rows.map(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rows$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toComment"]));
}
async function POST(req) {
    const { card_id, content } = await req.json();
    if (!content?.trim()) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    const ins = await db.execute({
        sql: 'INSERT INTO comments (card_id, content) VALUES (?, ?)',
        args: [
            parseInt(card_id),
            content.trim()
        ]
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rows$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toComment"])(row.rows[0]), {
        status: 201
    });
}
__turbopack_async_result__();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0vxc9w8._.js.map