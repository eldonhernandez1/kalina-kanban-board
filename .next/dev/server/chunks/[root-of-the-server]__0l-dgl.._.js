...
"[project]/src/app/api/cards/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(res.rows.map(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rows$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toCard"]));
}
async function POST(req) {
    const { stage_id, project_id, title } = await req.json();
    if (!title?.trim()) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    const maxRes = await db.execute({
        sql: 'SELECT MAX(position) as maxPos FROM cards WHERE stage_id = ?',
        args: [
            parseInt(stage_id)
        ]
    });
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rows$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toCard"])(row.rows[0]), {
        status: 201
    });
}
__turbopack_async_result__();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0l-dgl.._.js.map