...
"[project]/src/app/api/stages/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(res.rows.map(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rows$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toStage"]));
}
async function POST(req) {
    ...
    const maxRes = await db.execute({
        sql: 'SELECT MAX(position) as maxPos FROM stages WHERE project_id = ?',
        args: [
            parseInt(project_id)
        ]
    });
    ...
    const ins = await db.execute({
        sql: 'INSERT INTO stages (project_id, name, position) VALUES (?, ?, ?)',
        args: [
            parseInt(project_id),
            name.trim(),
            maxPos + 1
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rows$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toStage"])(row.rows[0]), {
        status: 201
    });
}
__turbopack_async_result__();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0kdt.cg._.js.map